  ...
  translation: {
    ...
    screen: {
      ...
      inconsistentVideoMode:
        'Воспроизведение приостановлено. Идёт воспроизведение другого видеорежима.',
      upload: 'Загрузить',
    ...
    image: {
      ...
      mounted: 'Смонтирован',
      fetchError:
        'Ошибка получения списка образов, пожалуйста, обновите страницу и попробуйте ещё раз',
    ...
    settings: {
      ...
      update: {
        ...
        uploadDesc:
          'Загрузите архив релиза nanokvm-pro-*.tar.gz. После установки устройство перезапустится.',
        chooseFile: 'Выбрать файл',
        invalidFile: 'Нужен архив релиза .tar.gz размером до 256 МБ.',
